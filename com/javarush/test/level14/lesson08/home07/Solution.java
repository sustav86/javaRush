...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament str: apartaments) {
            if (str instanceof Apt1Room) ((Apt1Room) str).clean1Room();
            else if (str instanceof Apt2Room) ((Apt2Room) str).clean2Rooms();
            else if (str instanceof Apt3Room) ((Apt3Room) str).clean3Rooms();
        }
    }
