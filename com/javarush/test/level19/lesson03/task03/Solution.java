...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer, Contact {
        ...
        public IncomeDataAdapter(IncomeData incomeDate) {
        ...
        public String getPhoneNumber()
        {
            ...
            phone += Integer.toString(this.incomeData.getPhoneNumber());

            return "+" + "" + this.incomeData.getCountryPhoneCode() + "(" + phone.substring(0, 3) + ")" + phone.substring(3, 6) + "-" + phone.substring(6, 8) + "-" + phone.substring(8, 10);
        }
