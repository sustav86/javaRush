...
C class, method2
SearchMaximalElement class, method2
SearchMaximalElement class, method1
B class, method1
...
public class Solution {
    ...
    public static class A {
        ...
        private void method1() {
            System.out.println("SearchMaximalElement class, method1");
        }

        public void method2() {
            System.out.println("SearchMaximalElement class, method2");
            method1();
        }
    }
